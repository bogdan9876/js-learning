        ...
        <nav className="bg-white shadow-md py-4 border-b-gray-200">
            ...
            <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
                ...
                <div className="flex items-center space-x-4">
                    {session ? (
                        <>
                        <Link href={"/trips"} className="text-slate-900 hover:text-sky-500">My Trips</Link><Link href={"/globe"} className="text-slate-900 hover:text-sky-500">Globe</Link>
                        ...
                        <button className="flex items-center justify-center bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-sm cursor-pointer" onClick={login}>
                            Sign In
                            <svg className="w-6 h-6 ml-2" viewBox="0 -3.5 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" fill="currentColor"
                            >
                                <g id="SVGRepo_iconCarrier"> <g fill="currentColor">
